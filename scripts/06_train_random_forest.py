"""
Random Forest Model Training Script with MLflow Tracking
"""
import pandas as pd
import numpy as np
...
from config.mlflow_config import setup_mlflow, print_mlflow_config, MODEL_NAME_RANDOM_FOREST
...
def train_random_forest_model():
    ...
    with mlflow.start_run(run_name="random_forest_model"):
        ...
        importance_path = models_dir / "random_forest_feature_importance.png"
        ...
        plt.tight_layout()
        residual_path = models_dir / "random_forest_residuals.png"
        ...
        mlflow.sklearn.log_model(
            model,
            "model",
            registered_model_name=MODEL_NAME_RANDOM_FOREST
        )
        
        print("   ✓ Logged parameters, metrics, and artifacts to MLflow")
        print(f"   ✓ Model registered as: {MODEL_NAME_RANDOM_FOREST}")
